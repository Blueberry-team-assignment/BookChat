...
MEDIA_ROOT = os.path.join(BASE_DIR, 'images')  # frontend/images 경로
...
DATABASES = {
    'default': {
        ...
        'CONN_MAX_AGE': 60,  # 60초 후 연결 자동 종료
        'OPTIONS': {
            'keepalives': 1,
            'keepalives_idle': 30,
...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'dwt4yri9e',
    'API_KEY': '884834829279796',
    'API_SECRET': 'TYRcjhRaYnP6uKjtIiuj9fzkq9Y'
}
